...
for ind in range(len(betas)):
	...
	beta = beta_ref * beta0
	filename='data/forward/forward_' + str(int(beta_ref * 100)) + '_R_'+ str(R) +'.npz'
	data=np.load(filename)
...
ax[0, 0].plot(steps, mP_t1_t_mean, dashes=line[0],color=colors[0],lw=lws[0], label=labels[0])
ax[0, 0].plot(steps, mP_t_mean, dashes=line[1],color=colors[1],lw=lws[1], label=labels[1])
ax[0, 0].plot(steps, mP_t1_mean, dashes=line[2],color=colors[2],lw=lws[2], label=labels[2])
ax[0, 0].plot(steps, mP2_t_mean, dashes=line[3],color=colors[3],lw=lws[3], label=labels[3])
...
ax[1, 1].plot(C_exp[iu1], CP_t1_t[iu1], 'v', color=colors[0], ms=3, rasterized=True)
ax[1, 1].plot(C_exp[iu1], CP_t[iu1], 's', color=colors[1], ms=3, rasterized=True)
ax[1, 1].plot(C_exp[iu1], CP_t1[iu1], 'd', color=colors[2], ms=3, rasterized=True)
ax[1, 1].plot(C_exp[iu1], CP2_t[iu1], 'o', color=colors[3], ms=3, rasterized=True)
...
ax[1, 2].plot(D_exp.flatten(), DP_t1_t.flatten(), 'v',  color=colors[0], ms=3, rasterized=True)
ax[1, 2].plot(D_exp.flatten(), DP_t.flatten(), 's',  color=colors[1], ms=3, rasterized=True)
ax[1, 2].plot(D_exp.flatten(), DP_t1.flatten(), 'd',  color=colors[2], ms=3, rasterized=True)
ax[1, 2].plot(D_exp.flatten(), DP2_t.flatten(), 'o',  color=colors[3], ms=3, rasterized=True)
