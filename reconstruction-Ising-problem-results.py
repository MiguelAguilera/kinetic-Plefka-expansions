...
filename_exp = 'data/reconstruction/data-transition-gamma1-0.5-gamma2-0.1-s-512-R-10000-B-201.npz'
...
ax[nrow, ncol].plot(betas[np.argmax(CPexp)], [0.019], '*', ms=12, color='k')
ax[nrow, ncol].plot(betas[np.argmax(CP_t1_t_0)], [ 0.019], '*', ms=12, color=colors[0])
ax[nrow, ncol].plot(betas[np.argmax(CP_t_0)], [0.021], '*', ms=12, color=colors[1])
ax[nrow, ncol].plot(betas[np.argmax(CP_t1_0)], [0.019], '*', ms=12, color=colors[2])
ax[nrow, ncol].plot(betas[np.argmax(CP2_t_0)], [0.019], '*', ms=12, color=colors[3])
ax[nrow, ncol].axis([np.min(betas), np.max(betas), 0, 0.022])
...
ax[nrow, ncol].plot(betas[np.argmax(DPexp)], [0.019], '*', ms=12, color='k')
ax[nrow, ncol].plot(betas[np.argmax(DP_t1_t_0)], [ 0.019], '*', ms=12, color=colors[0])
ax[nrow, ncol].plot(betas[np.argmax(DP_t_0)], [0.021], '*', ms=12, color=colors[1])
ax[nrow, ncol].plot(betas[np.argmax(DP_t1_0)], [0.019], '*', ms=12, color=colors[2])
ax[nrow, ncol].plot(betas[np.argmax(DP2_t_0)], [0.019], '*', ms=12, color=colors[3])
ax[nrow, ncol].axis([np.min(betas), np.max(betas), 0, 0.022])
ax[nrow, ncol].set_xlabel(r'$\beta / \beta_c$', fontsize=18)
...
ax[nrow, ncol].plot(betas[np.argmax(sigmaPexp)], [110], '*', ms=12, color='k')
ax[nrow, ncol].plot(betas[np.argmax(sigmaP_t1_t_0)], [ 130], '*', ms=12, color=colors[0])
ax[nrow, ncol].plot(betas[np.argmax(sigmaP_t_0)], [ 130], '*', ms=12, color=colors[1])
ax[nrow, ncol].plot(betas[np.argmax(sigmaP_t1_0)], [ 110], '*', ms=12, color=colors[2])
ax[nrow, ncol].plot(betas[np.argmax(sigmaP2_t_0)], [ 120], '*', ms=12, color=colors[3])
...
ax[nrow, ncol].plot(betas[np.argmax(CPexp)], [0.017], '*', ms=12, color='k')
ax[nrow, ncol].plot(betas[np.argmax(CP_t1_t)], [0.017], '*', ms=12, color=colors[0])
ax[nrow, ncol].plot(betas[np.argmax(CP_t)], [0.017], '*', ms=12, color=colors[1])
ax[nrow, ncol].plot(betas[np.argmax(CP_t1)], [0.019], '*', ms=12, color=colors[2])
ax[nrow, ncol].plot(betas[np.argmax(CP2_t)], [0.021], '*', ms=12, color=colors[3])
ax[nrow, ncol].axis([np.min(betas), np.max(betas), 0, 0.022])
...
ax[nrow, ncol].plot(betas[np.argmax(DPexp)], [0.019], '*', ms=12, color='k')
ax[nrow, ncol].plot(betas[np.argmax(DP_t1_t)], [0.019], '*', ms=12, color=colors[0])
ax[nrow, ncol].plot(betas[np.argmax(DP_t)], [0.019], '*', ms=12, color=colors[1])
ax[nrow, ncol].plot(betas[np.argmax(DP_t1)], [0.017], '*', ms=12, color=colors[2])
ax[nrow, ncol].plot(betas[np.argmax(DP2_t)], [0.021], '*', ms=12, color=colors[3])
ax[nrow, ncol].axis([np.min(betas), np.max(betas), 0, 0.022])
ax[nrow, ncol].set_xlabel(r'$\tilde\beta$', fontsize=18)
ax[nrow, ncol].set_ylabel(r'$\langle D_{il,t} \rangle$', fontsize=18, rotation=0, labelpad=25)
...
ax[nrow, ncol].plot(betas, sigmaPexp, color='k')
ax[nrow, ncol].plot(betas[np.argmax(sigmaPexp)], [110], '*', ms=12, color='k')
ax[nrow, ncol].plot(betas[np.argmax(sigmaP_t1_t)], [ 120], '*', ms=12, color=colors[0])
ax[nrow, ncol].plot(betas[np.argmax(sigmaP_t)], [ 100], '*', ms=12, color=colors[1])
ax[nrow, ncol].plot(betas[np.argmax(sigmaP_t1)], [ 130], '*', ms=12, color=colors[2])
ax[nrow, ncol].plot(betas[np.argmax(sigmaP2_t)], [ 120], '*', ms=12, color=colors[3])
